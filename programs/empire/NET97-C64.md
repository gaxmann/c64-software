...
This document summarises the reconstructed hardware and software behaviour for a max. 4-node C64 userport network used by “Empire C64”. The original documentation is lost. This document has been reconstructed from memory. The software uses the powerful serial port of the CIA 6526 inside the Commodore 64 at ca. 8 kB/s (#$07 in timer A). With only two C64 higher transfer rates had been possible. (The standard VC1541 transfers with 0.6 kB/s.)   
