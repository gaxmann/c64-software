...
## Addendum (Jan 2026): arbitration timing + optional PB6 LED (confirmed in `sd2.75`)
...
(If you implement the PB6 LED: use a low-current LED and a series resistor to +5 V, similar to the PB7 LED concept. PB6 is not part of the 4-wire bus; it is local to the plug.)
